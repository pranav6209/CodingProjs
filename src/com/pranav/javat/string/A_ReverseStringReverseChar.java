...
public class A_ReverseStringReverseChar {
	...
	public static String reverseString(String str) {
		 ...
		 * Steps To Remember
		 * 
		 * 1. String to chatArray 2. iterate in reverse i= array.legnth-1 to >=0
	...
	public static void main(String[] args) {
		...
		System.out.println(A_ReverseStringReverseChar.reverseString(""));
		System.out.println(A_ReverseStringReverseChar.reverseString("a"));
